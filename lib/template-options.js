    ...
    for (let key in optd.defaults) {
      ...
      if (optd.defaults[key] && !isRx && typeof optd.defaults[key] === 'object') {
        ...
        for (let key2 in optd.defaults[key]) {
          val[key2] = !opts || !opts[key] || typeof opts[key][key2] === 'undefined' ? optd.defaults[key][key2] : opts[key][key2];
        }
        Object.freeze(val);
      } else val = !opts || typeof opts[key] === 'undefined' ? optd.defaults[key] : opts[key];
