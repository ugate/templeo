 ...
 * @typedef {Object} module:templeo/compile.Options
 ...
 * controlled by the `cache`. See the various `engine*` derivatives of the engine being used for more details.
 */
 ...
 * @typedef {Object} module:templeo/render.Options
...
const DEFAULT_RENDER_OPTS = Object.freeze({
...
// TODO : ESM use... export class TemplateOpts {
  ...
  /**
   * Template compilation options
   * @param {module:templeo/compile.Options} [opts] The template compilation options
   * @param {Boolean} [forRendering] `true` for render options, `false` for compile options
   */
  constructor(opts, forRendering) {
    this.build(opts, forRendering ? DEFAULT_RENDER_OPTS : DEFAULT_COMPILE_OPTS, this);
  }
  ...
  /**
   * @returns {module:templeo/compile.Options} The default options
   */
   ...
   * @returns {module:templeo/compile.Options} The default options
   */
  static get defaultRenderOptions() {
