 ...
 * @property {String} [partialStoreName='partials'] The name assigned to the store maintained by the `Cachier` for partial template content
 * @property {String} [sourceStoreName='sources'] The name assigned to the store maintained by the `Cachier` for compiled sources
...
const DEFAULTS = Object.freeze({
  ...
  varName: 'it',
  filename: /^(.*[\\\/]|^)([^\.]*)(.*)$/,
  partialStoreName: 'partials',
  sourceStoreName: 'sources',
