 ...
 * context _object_. The name will be used to `read` the context immediately prior to rendering. __Compile-time only option.__
 ...
 * @property {String} [renderTimePolicy=read-write] The policy applied to partial template DB `read`/`write` operations when encountering
 ...
 * `uglify-js` options. __Compile-time only option.__
