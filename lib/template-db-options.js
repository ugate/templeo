 ...
 * @property {String} [renderTimePolicy=read-all-on-init-when-empty-write] The policy applied to partial template DB `read` operations when encountering
 ...
 * - `read-write-and-close` Like the __read__ policy, partial templates are only read when include directives are encountered that do not already contain content.
...
const OPTIONS = Object.freeze({
  defaults: Object.freeze({
    ...
    dbLocName: 'templeo',
    renderTimePolicy: 'read-all-on-init-when-empty-write'
  }),
