...
// TODO : ESM use... export class Cachier {
   ...
   * `{ reader:Function, finish:Function }` where the reader is the aforementioned reader function and __finish__ is an
   * `async function(storage:Object)` that can perform cleanup tasks for each reader after rendering has completed. The __storage__
