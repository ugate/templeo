...
// TODO : ESM use... export class Cachier {
   ...
   */
  get operations() {
    return Object.freeze({ read: fetcher });
  }
   ...
   * @returns {Object} `namers.namerOnReadError` The naming function to use when a {@link Cachier.operations} function throws an error. The next
