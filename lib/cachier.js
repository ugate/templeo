...
// TODO : ESM use... export class Cachier {
  ...
  async read(name, forContent) {
    ...
    const url = forContent && isAbsName(name, ns.at.options) ? ns.this.readWriteName(name, ns.at.options, forContent) : null;
 ...
 */
function readWriteName(name, optional, forContent) {
  const isOptionFunc = typeof optional === 'function';
