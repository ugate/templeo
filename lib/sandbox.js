 ...
 */
async function renderContent(name, path, content, params) {
  ...
  if (policy.includes('write')) {
    ...
    for (let op of operations) {
      ...
      renderer = await op.write(name, path, null, true, optional, params, store, block, writeFormatter, isClosePolicy, log);
