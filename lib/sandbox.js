...
class Sandbox {
   ...
   * takes 1 or 2 arguments with the first being the content that will be formatted and the second being the `options.formatOptions`.
...
function renderContent(name, content, params) {
  ...
  if (policy.includes('write')) {
    /*for (let op of operations) {
      ...
      renderer = await op.write(name, optional, params, store, writeFormatter, policy.includes('close'), log)
