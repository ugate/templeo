...
function coded(name, template, includes, compileOpts, directives, nameRegExp, namers, operations, log, params, compileMeta, storeMeta, metadata) {
  ...
  storex += 'const store={data:includes';
  if (compileMeta) {
  ...
  const incl = `let include,ctx,_readHandler; { ${logx}${namex}${opx} { ${nmreg}${coptx}${roptx}${frmtx}${inclsx}${storex}${varx}${dirsx}${sandx}${inclx}${itx} } }`;
