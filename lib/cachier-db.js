 ...
 */
async function execDB(name, optional, params, storage, close, logger, valueOrRemove, recordfunc, openFunc, openOnly) {
  ...
  return new Promise(async (resolve, reject) => {
    const end = async error => {
      if (close) {
        ...
        } else if (logger && logger.info) logger.info('DB may already be closed or manual "close" functionality is not implemented');
      }
