...
// TODO : ESM use... export class CachierDB extends Cachier {
  ...
  async read(name, forContent, extension, params) {
    ...
    await execDB(rwname, opts, null, storage, false, ns.at.logger, undefined, null, function openDB(storage) {
      ns.at.db = storage.db;
      ns.at.idb = storage.idb;
    });
  ...
  async write(name, data, forContent, extension, params) {
    ...
    const storage = { db: ns.at.db, idb: ns.at.idb };
    await execDB(rwname, opts, null, storage, false, ns.at.logger, put, null, function openDB(storage) {
      ns.at.db = storage.db;
      ns.at.idb = storage.idb;
    });
  }
