...
// TODO : ESM use... export class EngineOpts {
   ...
   * partial.
   * @param {String} [opts.outputPath] When defined, templates will be written to {@link Cache} (__otherwise, compiled templates reside
   * in-memory rather than processed via a {@link Cache} instance__)
   * @param {String} [opts.outputExtension=.js] Extension used for generated output sources __ignored when `outputPath` is omitted__
   * @param {Object} [opts.outputFormatting] The formatting options passed into {@link Cache} _format function_ that will format the compiled
