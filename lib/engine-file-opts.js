...
/**
 * Template engine options for a file/system back-end. All file options inherit from [EngineOpts]{@link module:templeo/options.Options}.
...
class EngineFileOpts extends EngineOpts {
  ...
  /**
   * Template engine file options
   * @param {module:templeo/options.FileOptions} [opts] The template engine file options
   */
  constructor(opts) {
    super(opts);
  }
